...
CREATE TABLE bookings (
    ...
    status ENUM('Pending', 'Awaiting Payment', 'Payment Submitted', 'Confirmed', 'Assigned', 'Active', 'Completed', 'Cancelled') DEFAULT 'Pending',
    notes TEXT,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE payments (
    ...
    payment_method ENUM('M-Pesa', 'Cash', 'Bank Transfer') NOT NULL,
